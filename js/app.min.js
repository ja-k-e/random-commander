        ...
        $scope.progress = 0, $scope.playPerformance = function() {
            ...
            next_beat = function() {
                ...
                for (i = _i = 0, _len = performance.length; _len > _i; i = ++_i) {
                    ...
                    decibels.push(composition.clefs.bass.decibels)), bps = tempo / 60, beat_count = chord.length / (1 / resolution), 
                    res_beats = 4 / resolution, beat_sus = res_beats / bps, sustain = beat_count * beat_sus, 
                    notes_size = chord.notes.length, chord_0 = performance[0][index], chord_1 = performance[1] ? performance[1][index] : null, 
