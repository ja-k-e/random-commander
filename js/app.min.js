(function() {
    ...
    app.controller("EditorCtrl", [ "$scope", function($scope) {
        ...
        }, $scope.presets = Presets, $scope.composition = Presets.jonny, $scope.performance = Performance.getPerformance($scope.composition), 
        ...
        $scope.progress = 0, $scope.playPerformance = function() {
            ...
            return $scope.playing = !0, composition = $scope.composition, performance = $scope.performance, 
            beats = composition.measures * composition.beats * composition.resolution / 4, index = 0, 
            tempo_time = 6e4 / composition.tempo, next_beat = function() {
                ...
                for (i = _i = 0, _len = performance.length; _len > _i; i = ++_i) {
                    ...
                    decibels.push(composition.clefs.bass.decibels)), bps = composition.tempo / 60, beat_count = chord.length / (1 / composition.resolution), 
                    sustain = beat_count * bps * (1 / composition.resolution) * .99, notes_size = chord.notes.length, 
